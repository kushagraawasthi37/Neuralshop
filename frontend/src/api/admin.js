...
export const analyticsApi = {
  ...
  agentGrowth: (params) => api.get("/analytics/agent-growth", { params }),
};
...
export const adminOrdersApi = {
  ...
  bulkUpdateStatus: (updates) =>
    api.patch("/admin/orders/bulk/status", { updates }),
};
...
export const adminCouponsApi = {
  ...
  toggle: (couponId, isActive) =>
    api.patch(`/coupons/admin/${couponId}/toggle`),
...
export const adminReturnsApi = {
  ...
  reject: (returnId, reason) =>
    api.patch(`/returns/admin/${returnId}/reject`, { reason }),
  processRefund: (returnId) => api.patch(`/returns/admin/${returnId}/refund`),
  markRefundFailed: (returnId) =>
    api.patch(`/returns/admin/${returnId}/refund-failed`),
};
