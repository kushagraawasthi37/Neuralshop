...
export default function AnalyticsPanel() {
  ...
  const maxRevenue = Math.max(
    1,
    topProducts.reduce((max, p) => Math.max(max, p._sum?.price || 0), 0),
  );
        ...
        <>
          <div className="four-col" style={{ marginBottom: 2 }}>
            ...
            <div className="analytics-metric">
              ...
              <div className="analytics-val">
                {fmtNum(dashboard?.totalOrders)}
              </div>
            </div>
            <div className="analytics-metric">
              <div className="analytics-label">Avg Order Value</div>
              <div className="analytics-val">
                {fmt(dashboard?.avgOrderValue)}
              </div>
            </div>
            <div className="analytics-metric">
              <div className="analytics-label">Pending Orders</div>
              <div className="analytics-val">{fmtNum(pendingOrders)}</div>
            </div>
          </div>
        ...
        <>
          <div className="three-col" style={{ marginBottom: 2 }}>
            <div className="analytics-metric">
              ...
              <div className="analytics-val">
                {fmtNum(dashboard?.totalCustomers)}
              </div>
            </div>
            <div className="analytics-metric">
              <div className="analytics-label">New This Month</div>
              <div className="analytics-val">
                {fmtNum(custData?.newCustomers)}
              </div>
            </div>
            <div className="analytics-metric">
              <div className="analytics-label">Repeat Buyers</div>
              <div className="analytics-val">
                {fmtNum(custData?.repeatCustomers)}
              </div>
            </div>
          </div>
          <div className="card mt-2">
