...
export default function CartPage() {
  ...
  const handleApplyCoupon = async () => {
    ...
    try {
      console.log("Applying coupon", couponCode, "to subtotal", subtotal);
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    fontFamily:
                      "'DM Sans',sans-serif', transition: 'color 0.3s'",
                  }}
                >
                  Clear All
                </button>
              ...
              {coupon && (
                <div
                  style={{
                    ...
                    border: "1px solid rgba(74,92,71,0.3)",
                    fontSize: 12,
                ...
                {[
                  ...
                  >
                    ...
                    <span
                      style={{
                        fontSize: 14,
                        color: row.green ? "rgba(138,173,135,0.9)" : "#f0e6d0",
                        fontFamily: "'DM Mono',monospace",
                      }}
                    >
                      {row.value}
