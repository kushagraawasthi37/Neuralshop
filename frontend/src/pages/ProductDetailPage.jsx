...
export default function ProductDetailPage() {
  ...
  const { data: similar = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      console.log("SIMILAR API RESPONSE 👉", res.data); // 🔥 yaha dekh
  ...
  return (
    <div style={{ minHeight: "100vh", paddingTop: 80 }}>
      ...
      >
        ...
        <div style={{ paddingTop: 48, paddingLeft: 52, paddingBottom: 48 }}>
            ...
            {discount && (
              <span
                style={{
                  ...
                  background: "rgba(74,92,71,0.15)",
                  border: "1px solid rgba(74,92,71,0.35)",
                  padding: "3px 10px",
                }}
              >
                Save {discount}%
          ...
          <div style={{ display: "flex", gap: 12, marginBottom: 28 }}>
            ...
            <button
              onClick={() => wishlistMutation.mutate(!wishlistStatus)}
              style={{
                width: 52,
                height: 52,
                border: "1px solid rgba(201,169,110,0.25)",
                background: wishlistStatus ? "rgba(201,169,110,0.1)" : "none",
                cursor: "pointer",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
            ...
            >
              <span
                style={{
                  fontSize: 20,
                  color: wishlistStatus ? "#c9a96e" : "rgba(201,169,110,0.4)",
                  lineHeight: 1,
                }}
              >
                {wishlistStatus ? "♥" : "♡"}
      ...
      {/* You May Like (personalised / contextual picks) */}
      {youMayLike.length > 0 && (
        <div
          style={{
            maxWidth: 1400,
        ...
        >
          <div style={{ paddingTop: 64, marginBottom: 40 }}>
            ...
            >
              You May{" "}
              <em style={{ fontStyle: "italic", color: "#c9a96e" }}>Like</em>
            </div>
          </div>
          <div
            style={{
