...
export default function VerifyEmailPage() {
  ...
  useEffect(() => {
    if (!pendingEmail)
      navigate(pendingRole === "admin" ? "/admin/register" : "/register");
      ...
      {success ? (
        ...
        <>
          ...
          <div style={{ marginTop: 24 }}>
            <AuthBtn onClick={handleVerify} loading={loading} type="button">
              Verify & Continue →
            </AuthBtn>
          </div>
          ...
          >
            ...
            <TextLink
              onClick={() =>
                navigate(
                  pendingRole === "admin" ? "/admin/register" : "/register",
                )
              }
            >
              ← Back to register
